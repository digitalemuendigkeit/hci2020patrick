...
We decided for the Barabási Albert topology as it provides an artificial network structure that is similar to real world social networks [@wilson_user_2009].

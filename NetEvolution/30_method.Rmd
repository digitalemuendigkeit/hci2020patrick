...
- Difference between individual's opinion and individual's perceived public opinion
...
The measures were all calculated from the final state of the simulation runs and averaged over all repetitions of the same run so that we are able to calculate confidence intervals for the outcomes of the simulation runs.

...
In terms of network centrality, only the closeness centrality increases through more agents while betweenness and eigenvector centrality decrease (see Table \@ref(tab:netsizecentrality)).
...
\begin{table}[]
\caption{Influence of network size on centrality measures.}\label{tab:netsizecentrality}
\begin{tabular}{lllllll}
\hline
             & \multicolumn{2}{l}{Closeness Centrality} & \multicolumn{2}{l}{Betweenness Centrality} & \multicolumn{2}{l}{Eigenvector Centrality} \\
Network size & mean                & sd                 & mean                 & sd                  & mean                 & sd                  \\
\hline
100          & 0.3957              & 0.0242             & 0.0156               & 0.0017              & 0.0816               & 0.0043              \\
200          & 0.4303              & 0.0096             & 0.0067               & 0.0003              & 0.0551               & 0.0019              \\
300          & 0.4477              & 0.0060             & 0.0042               & 0.0001              & 0.0447               & 0.0012              \\
400          & 0.4551              & 0.0090             & 0.0030               & 0.0002              & 0.0382               & 0.0011              \\
500          & 0.4610              & 0.0070             & 0.0024               & 0.0001              & 0.0341               & 0.0007         \\
\hline
\end{tabular}
\end{table}
...
The role of the agent with the highest follower count also depends on the unfriend threshold (see Table \@ref(tab:unfriendthresh)).
...
\begin{table}[]
\caption{Influence of unfriend threshold.}\label{tab:unfriendthresh}
\begin{tabular}{llllll}
\hline
ConfigUnfriendThresh                                                                        & 0.4     & 0.6     & 0.8     & 1       & 1.2     \\ \hline
Densities                                                                                   & 0.063   & 0.082   & 0.094   & 0.108   & 0.115   \\
Outdegree SD                                                                                & 26.693  & 27.921  & 29.209  & 31.545  & 36.109  \\
Indegree SD                                                                                 & 19.050  & 23.133  & 26.923  & 30.335  & 35.134  \\
Outdegree/Indegre Ratio                                                                     & 0.479   & 0.491   & 0.496   & 0.498   & 0.498   \\
Closeness Centrality                                                                        & 0.426   & 0.460   & 0.482   & 0.499   & 0.521   \\
Betweenness Centrality                                                                      & 0.003   & 0.002   & 0.002   & 0.002   & 0.002   \\
Eigenvector Centrality                                                                      & 0.031   & 0.034   & 0.036   & 0.038   & 0.038   \\
Clustering Coefficient                                                                      & 0.051   & 0.055   & 0.055   & 0.058   & 0.060   \\
Communitycount                                                                              & 6.700   & 3.200   & 1.170   & 1.350   & 1.290   \\
Opinion SD                                                                                  & 0.070   & 0.096   & 0.470   & 0.582   & 0.589   \\
Opinionchange Delta                                                                         & 0.496   & 0.487   & 0.256   & 0.215   & 0.274   \\
Difference public/own opinion                                                               & 0.021   & 0.025   & 0.120   & 0.170   & 0.184   \\
Supernode Outdegree                                                                         & 208.030 & 205.920 & 201.590 & 206.360 & 244.780 \\
Supernode Closeness Centrality                                                              & 0.629   & 0.628   & 0.624   & 0.631   & 0.663   \\
Supernode Betweenness Centrality                                                            & 0.054   & 0.041   & 0.033   & 0.029   & 0.037   \\
Supernode Eigenvector Centrality                                                            & 0.183   & 0.164   & 0.152   & 0.139   & 0.148   \\
\begin{tabular}[c]{@{}l@{}}Opinion Difference between \\ 1st and 2nd supernode\end{tabular} & 0.005   & 0.027   & 0.252   & 0.362   & 0.085   \\ \hline
\end{tabular}
\end{table}

...
## Impact of the addfriends mechanism

The mechanism for adding new friends shows an influence for the network and the opinion distribution in it (see Table \@ref(tab:AddfriendsTable)).
...
The least influence of the addfriends mechanism can be perceived in terms of network centrality of each agent.
...
The node with the highest influence and outreach in the network is not affected by the addfriends mechanism.

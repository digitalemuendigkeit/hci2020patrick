...
While the standard deviations of outdegree and indegree for each agent to not differ significantly between the different approaches, the mean ratio between outdegree and indegree per agent is less balanced when agents only choose from neighbors of neighbors (0.48) compared to random (0.49) and hybrid (0.49) approaches.

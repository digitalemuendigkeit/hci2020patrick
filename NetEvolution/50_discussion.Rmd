...
An extensive analysis of the friendship relations in Facebook of Wilson et al. shows that the actual structure of the social graph shows similarities and a powerl-law distribution of degrees like in Barabási-Albert networks.
Nevertheless a fitting of the model parameters is required to facilitate the generation of a realistic artificial network and additional factors as network growth have to be taken into account [@Wilson2009].

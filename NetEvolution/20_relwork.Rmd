...
In addition to the deception that is initiated through particular users, the algorithms that are used by social media platforms for presenting relevant content can also lead to misguided perceptions of the oppinion climate [@Nguyen2014]. To reveal the true effect of such algorithms it is inevitable to precisely analyze their interaction with the users [@CaleroValdez2018a].

...
While this increased exposure could be suspected as positive influence on the opinion formation, this type of media also shows more vulnerability for misleading the public discourse on certain topics like it got evident for events as the Brexit, .., or most recently the spread of wrong information about the corona virus [@McCloskey2020].<!-- Hier fehlt glaube ich noch was? -->

Furthermore, it is crucial to consider the imbalance of activity of social media users. 
As Romero et al. found, the majority of users passively consume content on social media platforms and rarely take part in interactions, while only a little part of the users utilize those platforms to actively contribute new content and spread their opinions which transforms them into secondary gate keepers of information spread.<!-- Referenze zu Romero?, "kind of" umganzsprachliches füllwort, würde ich weglassen -->
...
<!-- Der Satz ist mir nicht so ganz klar, welcher effekt auf plarization zeigt keine signifikanz? -->
...
To reproduce an online social network in a simulation, we have to rely on a network generator that is comparable to a real network. 
...
<!-- Referenz zu Varabasi-Albert? Für mich klingt das fast schon nach Methode, vielleicht ist das eine gute stelle für eine Überleitung zur methode? -->
...
results %>% 
  filter(BatchName == "Netsize") %>% 
  select(ConfigAgentCountFactor, AgentsAboveMeanSD) %>% 
  ggplot(aes(x = ConfigAgentCountFactor, y = AgentsAboveMeanSD)) +
  geom_jitter(alpha = 0.3, width = 0.2) +
  geom_violin(alpha = 0.1, fill = "black") +
  geom_boxplot(alpha = 0.5, aes(fill = ConfigAgentCountFactor)) +
  theme_bw() +
...
results %>% 
  filter(BatchName == "Netsize") %>% 
  select(ConfigAgentCountFactor, CommunityCount) %>% 
  ggplot(aes(x = ConfigAgentCountFactor, y = CommunityCount)) +
  geom_jitter(alpha = 0.3, width = 0.2) +
  geom_violin(alpha = 0.1, fill = "black") +
  geom_boxplot(alpha = 0.5, aes(fill = ConfigAgentCountFactor)) +
  theme_bw() +
...
results %>% 
  filter(BatchName == "Addfriends") %>% 
  select(ConfigAddfriendMethod, AgentsAboveMeanSD) %>% 
  ggplot(aes(x = ConfigAddfriendMethod, y = AgentsAboveMeanSD)) +
  geom_jitter(alpha = 0.3, width = 0.2) +
  geom_violin(alpha = 0.1, fill = "black") +
  geom_boxplot(alpha = 0.5, aes(fill = ConfigAddfriendMethod)) +
  theme_bw() +

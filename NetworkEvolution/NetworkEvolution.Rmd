...
This allows us to examine subsequently the influence of the factor levels seperately. Each distinct simulation configuration was repeated 50 times to clear out effects that are due to usage of random numbers in the simulations.



## Impact of Network Size
- Relative Edgecount decreases with higher net size

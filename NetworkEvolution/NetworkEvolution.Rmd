...
As shown in the previous section there are several ways to model the dynamics in opinion formation. We decided to 
...
This allows us to examine subsequently the influence of the factor levels seperately. Each distinct simulation configuration was repeated 100 times to clear out effects that are due to usage of random number generators in the simulations. The values that are reported in the following are always averaged over the repetitions.
